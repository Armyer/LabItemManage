...
import com.edu.szu.csse.utils.MD5Util;
...
import com.edu.szu.csse.bean.user.TokenExample;
import com.edu.szu.csse.bean.user.TokenExample.Criteria;
import com.edu.szu.csse.mapper.user.TokenMapper;

@Service
@Transactional
@MapperScan("cn.qlq.mapper.user")
